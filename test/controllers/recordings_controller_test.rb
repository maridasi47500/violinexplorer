...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post recordings_url, params: { recording: { filename: @recording.filename, song_id: @recording.song_id } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { filename: @recording.filename, song_id: @recording.song_id } }
